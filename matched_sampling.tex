...
\end{equation*}
where $g_k^j$ is the $j$th estimated gradient for minibatch $k$.  Since the variance-minimizing baseline and matched-sampling implicit baseline technique are unbiased, $MSE$ is the variance of the estimator.  %NVIL, in contrast, is biased, 
