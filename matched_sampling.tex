...
In directed models, sampling is only efficient if it can be performed via an ancestral pass.    %condition on child variables if the parents are not also specified.  
